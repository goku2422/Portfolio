...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-12 sm:py-20 bg-[#020817] overflow-hidden w-full max-w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 w-full max-w-full">
          ...
          >
            <div className="bg-blue-500/5 border border-blue-500/20 rounded-2xl p-4 sm:p-6 md:p-8 backdrop-blur-sm h-full flex flex-col justify-between w-full min-w-0 overflow-hidden box-border">
              <div>
                ...
                <div className="space-y-3 sm:space-y-4 w-full min-w-0">
                  {contactInfo.map((item, index) => (
                    <motion.a
                      ...
                      whileHover={{ x: 5 }}
                      className="flex items-center space-x-3 sm:space-x-4 p-2.5 sm:p-3 rounded-xl hover:bg-blue-500/10 transition-all duration-300 group overflow-hidden border border-transparent hover:border-blue-500/20 w-full min-w-0 box-border"
                    >
                      ...
                      <div className="min-w-0 flex-1 overflow-hidden">
                        ...
                        <p className="text-white font-semibold text-xs sm:text-sm md:text-base break-all sm:truncate leading-tight mt-0.5">{item.value}</p>
                      </div>
                    </motion.a>
                  ))}
                </div>
          ...
          <motion.div
            ...
            className="w-full min-w-0"
          >
            <form onSubmit={handleSubmit} className="bg-blue-500/5 border border-blue-500/20 rounded-2xl p-4 sm:p-6 md:p-8 backdrop-blur-sm w-full min-w-0 overflow-hidden box-border">
              ...
              <div className="space-y-4 sm:space-y-5 w-full min-w-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full min-w-0">
                  <div className="w-full min-w-0">
                    ...
                    <input
                      ...
                      required
                      className="w-full min-w-0 box-border px-3.5 py-2.5 sm:px-4 sm:py-3 bg-[#020817] dark:bg-[#020817] border border-blue-500/30 rounded-xl text-white placeholder-gray-500 text-base focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300"
                ...
                <div className="w-full min-w-0">
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full min-w-0 box-border px-3.5 py-2.5 sm:px-4 sm:py-3 bg-[#020817] dark:bg-[#020817] border border-blue-500/30 rounded-xl text-white placeholder-gray-500 text-base focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 resize-none"
